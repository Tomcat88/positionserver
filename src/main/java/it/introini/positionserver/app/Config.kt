...
fun getConfigInt(parameter: PARAMETER):    Int    = Vertx.currentContext().config().getInteger(parameter.name) ?: if(parameter.default is Int) parameter.default else error("default is not an int")
